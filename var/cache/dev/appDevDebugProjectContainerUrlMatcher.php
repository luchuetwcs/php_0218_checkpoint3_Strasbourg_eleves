...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        elseif (0 === strpos($pathinfo, '/boat')) {
            if (0 === strpos($pathinfo, '/boat/move')) {
                // moveBoat
                if (preg_match('#^/boat/move/(?P<x>\\d+)/(?P<y>\\d+)$#sD', $pathinfo, $matches)) {
                ...
                // moveDirection
                if (preg_match('#^/boat/move/(?P<direction>[^/]++)$#sD', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'moveDirection')), array (  '_controller' => 'AppBundle\\Controller\\BoatController::moveDirection',));
                }
