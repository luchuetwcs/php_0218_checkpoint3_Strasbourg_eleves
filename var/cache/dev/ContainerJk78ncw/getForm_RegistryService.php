...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\BoatType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\BoatType']) ? $this->services['AppBundle\Form\BoatType'] : $this->services['AppBundle\Form\BoatType'] = new \AppBundle\Form\BoatType()) && false ?: '_'};
}, 'AppBundle\\Form\\TileType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\TileType']) ? $this->services['AppBundle\Form\TileType'] : $this->services['AppBundle\Form\TileType'] = new \AppBundle\Form\TileType()) && false ?: '_'};
